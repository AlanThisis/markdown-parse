...
public class MarkdownParseTest {
    ...
    public void testSnippet1() throws IOException{
        ArrayList<String> linksTester = new ArrayList<>();
        linksTester.add("`google.com");
        linksTester.add("google.com");
        linksTester.add("ucsd.edu");

        Path fileName = Path.of("snippet-1.md");
        String contents = Files.readString(fileName);
        ArrayList<String> links = MarkdownParse.getLinks(contents);
        assertEquals(linksTester, links);
    }

    @Test
    public void testSnippet2() throws IOException{
        ArrayList<String> linksTester = new ArrayList<>();
        linksTester.add("a.com");
        linksTester.add("a.com(())");
        linksTester.add("example.com");
    ...
    public void testSnippet3() throws IOException{
        ArrayList<String> linksTester = new ArrayList<>();
        linksTester.add("https://ucsd-cse15l-w22.github.io/");
